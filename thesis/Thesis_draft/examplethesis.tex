...
\begin{tabular}{|l|l|l|}
\hline
Road   Segment & INRIX   ID & MCS   ID \\ \hline
South          & 1071883675 & 1159     \\ \hline
North          & 225285973  & 1162     \\ \hline
\end{tabular}
\caption{INRIX ID and MCS ID for corresponding road segments.}
\label{table:segmentIDs}
\end{table}
